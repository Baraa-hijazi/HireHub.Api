...
the [Clean.Architecture.Solution.Template](https://github.com/jasontaylordev/HireHub.Api) version 8.0.5.
...
To learn more about the template go to the [project website](https://github.com/jasontaylordev/CleanArchitecture).